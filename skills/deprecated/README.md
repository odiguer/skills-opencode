...
- **[git-guardrails-claude-code](./git-guardrails-claude-code/SKILL.md)** — Claude Code-specific guardrails skill, replaced by [git-guardrails](../misc/git-guardrails/SKILL.md).
